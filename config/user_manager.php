...
class UserManager {
    ...
    public function registerUser($data) {
        ...
        try {
            ...
            // Insert user
            $query = "INSERT INTO users (username, password, role, first_name, last_name, email, is_active) 
                      VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public function getUsers($page = 1, $limit = 10, $search = '') {
        ...
        // Get users
        $query = "SELECT id, username, role, first_name, last_name, email, is_active, created_at 
